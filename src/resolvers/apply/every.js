...
exports.everyParallel = everyParallel;
var resolveParallel_ts_1 = require("../resolveParallel.ts");
function everyAsync(generator, predicate) {
    return __awaiter(this, void 0, void 0, function () {
        var index, next, e_1_1;
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 3:
                    ...
                    _a = false;
                    next = _d;
                    return [4 /*yield*/, predicate(next, index++)];
                case 4:
...
function everyParallel(generator, parallel, predicate) {
    var index = 0;
    return (0, resolveParallel_ts_1.resolveParallel)({
        generator: generator,
        parallel: parallel,
        onNext: function (value, resolve) {
            return __awaiter(this, void 0, void 0, function () {
                var match;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, predicate(value, index++)];
                        case 1:
                            match = _a.sent();
                            if (!match)
                                resolve(false);
