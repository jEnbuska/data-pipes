...
exports.lastParallel = lastParallel;
var resolveParallel_ts_1 = require("../resolveParallel.ts");
function lastSync(generator) {
    var last;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 11: return [2 /*return*/, last];
            }
        });
    });
}
function lastParallel(generator, parallel) {
    var last;
