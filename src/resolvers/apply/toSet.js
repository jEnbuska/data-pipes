...
exports.toSetParallel = toSetParallel;
var resolveParallel_ts_1 = require("../resolveParallel.ts");
function toSetAsync(generator) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 12: return [2 /*return*/, set];
            }
        });
    });
}
function toSetParallel(generator, parallel) {
    var set = new Set();
    var add = set.add.bind(set);
