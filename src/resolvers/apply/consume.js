...
exports.consumeSync = consumeSync;
exports.consumeAsync = consumeAsync;
exports.consumeParallel = consumeParallel;
var resolveParallel_ts_1 = require("../resolveParallel.ts");
function consumeSync(generator) {
    for (var _i = 0, generator_1 = generator; _i < generator_1.length; _i++) {
        var _ = generator_1[_i];
        /* Do nothing */
    }
}
function consumeAsync(generator) {
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    _e.label = 1;
                case 1: return [4 /*yield*/, generator_2.next()];
                case 2:
                    if (!(generator_2_1 = _e.sent(), _b = generator_2_1.done, !_b)) return [3 /*break*/, 4];
                ...
                case 6:
                    _e.trys.push([6, , 9, 10]);
                    if (!(!_a && !_b && (_c = generator_2.return))) return [3 /*break*/, 8];
...
function consumeParallel(generator, parallel) {
