...
exports.toReversedSync = toReversedSync;
exports.toReversedAsync = toReversedAsync;
exports.toReversedParallel = toReversedParallel;
var resolveParallel_ts_1 = require("../resolveParallel.ts");
function toReversedSync(generator) {
    var arr = [];
...
function toReversedAsync(generator) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 12: return [2 /*return*/, arr];
            }
        });
    });
}
function toReversedParallel(generator, parallel) {
    var arr = [];
