...
exports.countParallel = countParallel;
var resolveParallel_ts_1 = require("../resolveParallel.ts");
function counter(_acc, _next, index) {
    return index + 1;
}
function countSync(generator) {
    return generator.reduce(counter, 0);
}
function countAsync(generator) {
...
function countParallel(generator, parallel) {
    var count = 0;
