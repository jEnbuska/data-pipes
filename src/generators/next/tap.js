...
exports.tapParallel = tapParallel;
var withIndex_ts_1 = require("../../utils/withIndex.ts");
var createParallel_ts_1 = require("../createParallel.ts");
function tapSync(generator, consumer) {
    var index, _i, generator_1, next;
...
function tapAsync(generator, consumer) {
    return __asyncGenerator(this, arguments, function tapAsync_1() {
        var index, _a, generator_2, generator_2_1, next, e_1_1;
        var _b, e_1, _c, _d;
...
function tapParallel(generator, parallel, consumer) {
    var callback = (0, withIndex_ts_1.withIndex1)(consumer);
