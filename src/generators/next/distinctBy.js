...
exports.distinctBySync = distinctBySync;
exports.distinctByAsync = distinctByAsync;
exports.distinctByParallel = distinctByParallel;
var createParallel_ts_1 = require("../createParallel.ts");
function distinctBySync(generator, selector) {
    var set, _i, generator_1, next, key;
...
function distinctByAsync(generator, selector) {
    return __asyncGenerator(this, arguments, function distinctByAsync_1() {
        var set, _a, generator_2, generator_2_1, next, key, e_1_1;
        var _b, e_1, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 3:
                    ...
                    _a = false;
                    next = _d;
                    return [4 /*yield*/, __await(selector(next))];
                case 4:
                    key = _e.sent();
                    if (set.has(key))
                        return [3 /*break*/, 7];
...
function distinctByParallel(generator, parallel, selector) {
    var set = new Set();
    return (0, createParallel_ts_1.createParallel)({
        ...
        onNext: function (next) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, next.then(selector)];
                        case 1:
                            key = _a.sent();
                            if (set.has(key))
                                return [2 /*return*/, []];
