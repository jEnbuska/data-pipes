...
function filterAsync(generator, predicate) {
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 3:
                    ...
                    _a = false;
                    next = _d;
                    return [4 /*yield*/, __await(predicate(next, index++))];
                case 4:
...
function filterParallel(generator, parallel, predicate) {
    var callback = (0, withIndex_ts_1.withIndex1)(predicate);
