...
exports.dropParallel = dropParallel;
var createParallel_ts_1 = require("../createParallel.ts");
function dropAsync(generator, count) {
    return __asyncGenerator(this, arguments, function dropAsync_1() {
        var _a, generator_1, generator_1_1, next, e_1_1;
        var _b, e_1, _c, _d;
...
function dropParallel(generator, parallel, count) {
