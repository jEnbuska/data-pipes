...
exports.takeParallel = takeParallel;
var createParallel_ts_1 = require("../createParallel.ts");
function takeSync(generator, count) {
...
function takeAsync(generator, count) {
...
function takeParallel(generator, parallel, count) {
    if (count <= 0)
        return (function () { return __asyncGenerator(this, arguments, function () { return __generator(this, function (_a) {
            return [2 /*return*/];
        }); }); })();
