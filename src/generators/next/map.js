...
function mapAsync(generator, mapper) {
    return __asyncGenerator(this, arguments, function mapAsync_1() {
        var index, _a, generator_1, generator_1_1, next, e_1_1;
        var _b, e_1, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 3:
                    if (!(generator_1_1 = _e.sent(), _b = generator_1_1.done, !_b)) return [3 /*break*/, 7];
                    _d = generator_1_1.value;
                    _a = false;
                    next = _d;
                    return [4 /*yield*/, __await(mapper(next, index++))];
                ...
                case 9:
                    ...
                    if (!(!_a && !_b && (_c = generator_1.return))) return [3 /*break*/, 11];
...
function mapParallel(generator, parallel, mapper) {
    var callback = (0, withIndex_ts_1.withIndex1)(mapper);
